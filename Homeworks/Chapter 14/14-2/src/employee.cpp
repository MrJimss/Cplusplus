...
{
     Employee::Employee():name("No name yet"), ssn("No number yet"), netPay(0){/*deliberately empty*/}
     Employee::Employee(const string& theName, const string& theNumber):name(theName), ssn(theNumber), netPay(0){/*deliberately empty*/}
